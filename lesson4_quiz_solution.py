...
# '''
answer = 250 #provide answer
guess = 150 #provide guess
...
purchase_amount = 300.00   #amount of purchase
...
#Quiz 8: Boolean Expression For Conditions
# '''
# Depending on where an individual is from we need to tax them 
# appropriately.  The states of CA, MN, and 
# NY have taxes of 7.5%, 9.5%, and 8.9% respectively.
...
#11: For Loops - Practice Questions -Quick Brown Fox
...
#11: For Loops - Practice Questions - Multitples of 5
...
#Quiz 13: Modify Usernames with Range
usernames = ["Joey Tribbiani", "Monica Geller", "Chandler Bing", "Phoebe Buffay"]
...
for key, value in basket_items.items():
    print("fruits: {}    number_of_fruits: {}".format(key, value))
...
print("The total fruit is: {} and the total of non-fruit is {}".format(fruit_count, not_fruit_count))


# In[15]:


#Quiz 21: While Loop- Factorials with for-loop1
...
#Quiz 21: While Loop- Factorials with for-loop2
# number to find the factorial of
number = 6   
...
#Quiz 23: While Loop- Count By Check
start_num = 10 #provide some start number
...
#Quiz 23: While Loop- Nearest Square
limit = 40
...
#26:Check for Understanding For and while-loop.
...
# Quiz 34: Zip List to a Dictionary.
...
# Quiz 34: UnZip List to a Dictionary.
...
# Quiz 37: Filter Names By Scores.
scores = {
             "Rick Sanchez": 70,
             "Morty Smith": 35,
             "Summer Smith": 82,
